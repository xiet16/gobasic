...
/*
没有什么是包一层解决不了的，如果有，就再包一层
负载均衡代理
本质就是通过算法获取地址
*/

func NewBalanceLoadBalanceReverseProxy(c *middleware.SliceRouterContext, lb load_balance.LoadBalance) *httputil.ReverseProxy {
	//请求协调者
	...
	modifyFunc := func(resp *http.Response) error {
		...
		//websocket 代理下面两行设置status_code 和payload 会报错
